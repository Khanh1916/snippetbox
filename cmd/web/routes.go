...
func (app *application) routes() http.Handler {
	...
	router.Handler(http.MethodGet, "/snippet/backup", dynamic.ThenFunc(app.snippetBackup))
	router.Handler(http.MethodGet, "/snippet/backup/run", dynamic.ThenFunc(app.snippetBackupRun))
